...
/**
 * <code>Bureau</code> est une vue
 * Elle affiche le menu de l'IHM.
 * 
...
public class Bureau {
    ...
    /**
     * Constructeur permettant d'accéder à la fenêtre
     * 
    ...
    public void run() {
        ...
        // Panel du bouton pour pouvoir définir sa taille
        ...
        effacer.
        Possible solution :  
        - Essayer de mettre le graphique dans le JPanel centre, afin de pouvoir par la suite l'effacer
        */
