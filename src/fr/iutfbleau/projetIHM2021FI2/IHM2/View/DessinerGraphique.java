 ...
 * Elle permet de dessiner le graphique des ratio de l'hotel sur une période donnée
 * 
...
public class DessinerGraphique extends JComponent {
     ...
     * @param retour    retour
     * @param ratio     le ratio d'une date
     * @param ratioComp ratio sur une durée
     */
    ...
    /**
     * Dessin du graphique dans la fenêtre
     */
    @Override
