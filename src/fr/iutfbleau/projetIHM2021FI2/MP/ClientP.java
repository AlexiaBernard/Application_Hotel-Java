...
/**
 * Un client persistant tout bête
 */
public class ClientP implements Client {
    ...
    /**
     * permet de récupérer l'identifiant du client (qu'on suppose être le même pour
     * les différents systèmes, internes et externes à l'hôtel).
     * 
