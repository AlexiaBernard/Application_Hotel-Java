...
public class Main {
	public static void main(String[] args) {
		...
		// une fois que le modèle de PrereservationFactoryNP a du contenu, je peux le
		// caster en l'interface PreservationFactory de l'API correspondante pour que la
		// vue s'en serve.
