...
/**
 * <code>AfficherListe</code> est une vue Elle affiche la liste des chambres
 * libres de la même catégorie que la chambre à changer
 * 
...
public class AfficherListe {
    ...
    public void run() {
        ...
        valider.addActionListener(new TraitementListeValider(this.bookingPointComAPISeulement,
                this.grandLivreDOrAPISeulement, this.fenetre, prereservation, group, this.disponibles, centre));
    }
